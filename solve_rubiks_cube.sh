...
# Define paths
DOMAIN_FILE="domains/rubiks_cube_domain.pddl"
PROBLEM_DIR="problems/rubiks_cube_temp"
SOLUTION_DIR="solutions/rubiks_cube"
LOG_DIR="logs/rubiks_cube"
...
for PROBLEM_FILE in "$PROBLEM_DIR"/*.pddl; do
    ...
    # Run the planner
    "$PLANNER_IMAGE" "$DOMAIN_FILE" "$PROBLEM_FILE" "$OUTPUT_FILE" | tee "$LOG_FILE"
